...
This word list is generated by ChatGPT, so it would be good to review it and see which combinations make very little sense in normal writing.

Ideally, We would want to have phrasing briefs where the phrases belong to some sort of family, like "be good" and "be great" belonging to a "be" family. This way, the phrasing would be more intuitive. Also, it would be good to search the plover dictionary to see which words are already briefed.
